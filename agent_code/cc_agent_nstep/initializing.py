                    ...
                    for m in range(-1,4):
                        for n in range(2):
                            for o in range(-2,4):
                                ...
                                three_stop1 = feature_dict[str(np.array([i,j,k,0,m,n,o]))]
                                three_stop2 = feature_dict[str(np.array([0,j,k,l,m,n,o]))]
                                three_stop3 = feature_dict[str(np.array([i,0,k,l,m,n,o]))]
                                three_stop4 = feature_dict[str(np.array([i,j,0,l,m,n,o]))]
                                
                                #three waslls and already placed bomb
                                three_stop1wb = feature_dict[str(np.array([i,j,k,0,m,0,o]))]
                                three_stop2wb = feature_dict[str(np.array([0,j,k,l,m,0,o]))]
                                three_stop3wb = feature_dict[str(np.array([i,0,k,l,m,0,o]))]
                                three_stop4wb = feature_dict[str(np.array([i,j,0,l,m,0,o]))]
                                ...
                                three_open1 = feature_dict[str(np.array([i,0,0,0,m,n,o]))]
                                three_open2 = feature_dict[str(np.array([0,j,0,0,m,n,o]))]
                                three_open3 = feature_dict[str(np.array([0,0,k,0,m,n,o]))]
                                three_open4 = feature_dict[str(np.array([0,0,0,l,m,n,o]))]
