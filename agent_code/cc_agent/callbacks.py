...
def act(self, game_state: dict) -> str:
    ...
    if self.train and random.random() < random_prob:
        ...
        return ACTIONS[np.argmax(self.model[feature_index(state_to_features(game_state)),:])]

def find_coin(game_state: dict): #Function which finds nearest coin and decides then where to go
...
# =============================================================================
    ...
    _, score, bool_bomb, (x, y) = game_state['self']
    coin_target = find_coin(game_state) 
    field = game_state['field'].T
